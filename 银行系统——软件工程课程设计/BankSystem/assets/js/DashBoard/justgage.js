 ...
 * -----------------------------
 ...
 JustGage = function(config) {
  ...
  obj.config =
  {
    ...
    titleFontColor : kvLookup('titleFontColor', config, dataset,  "#4a4a4a"),
    ...
    valueFontColor : kvLookup('valueFontColor', config, dataset, "#0a0a0a"),
    ...
    labelFontColor : kvLookup('labelFontColor', config, dataset, "#a1a1a1"),
