...
KJT.component.transfer=(function($,window,undefined){
		...
		strLink:function(ret,id){
			var strBox=new Array();
		        	...
		        	strBox=['<tr>'
		                ...
		                ,'<th>'+ret.money+'</th>'
		                ,'<th>'
		                	,'<a href="#select_transfer?id='+ret.money+'?id='+ret.accountNumber+'?id='+ret.id+'"><button type="button" class="btn btn-success btn-sm">选择</button></a><a class="info"></a>'
		                ,'</th>'
		            ,'</tr>'];
